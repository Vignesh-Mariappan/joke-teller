// api key = 5bebf7c5c2e246ceb3ac5dced2782c80

const button = document.querySelector('.button');
const audioElement = document.querySelector('.audio');
const jokeTextBox = document.querySelector('.joke-box');
...
// Display the joke in the text box
function displayJoke(joke) {
    if(jokeTextBox.textContent) {
        jokeTextBox.textContent = "";
    }

    jokeTextBox.textContent = joke;
}

// Passing the joke to call the voiceRSS API
function tellMe(joke) {
    VoiceRSS.speech({
            key: '5bebf7c5c2e246ceb3ac5dced2782c80',
            src: joke,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
